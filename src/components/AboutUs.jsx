            ...
            <div className="flex flex-col w-full max-w-[240px] lg:max-w-[350px] bg-white shadow-lg rounded-lg border border-gray-200">
              ...
              <div className="p-4">
                <p className="text-sm font-normal py-2.5 text-gray-900">
                  Hi, Myself Aryan Manjarekar. I am A Student from Nagindas
                  Khandwala College pursuing my Master's Degree in Computer
                  Science.
                </p>
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-900 mb-2 block">
                    Introduction related to my Authenticated System Webapp
                  </span>
                  <span className="text-xs text-gray-500 font-normal">
                    This is A Authenticated System WebApp along with Enquiry
                    Option Integration
                  </span>
                </a>
              </div>
          ...
          <div className="w-full max-w-md bg-white shadow-lg rounded-lg border border-gray-200">
            ...
            <div className="p-4">
              <p className="text-sm text-gray-600 mb-4">
                My Project is Made using This JavaScript Stack.
              </p>
